...
$emailValidationSuccess = $('<p id="email-validation-success">Validation successful</p>'),
$emailValidationFail = $('<p id="email-validation-fail">Validation failed</p>');
...
function willValidatedOnFocusout() {
    isValidated = true;
}
